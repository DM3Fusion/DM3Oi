...
export const permissions = [
  "MANAGE_PLATFORM",
  "VIEW_DASHBOARD","VIEW_CASES","CREATE_CASE","WORK_CASES","ASSIGN_CASES","REASSIGN_CASE_CUSTOMER","DELETE_DRAFT_INTAKES",
