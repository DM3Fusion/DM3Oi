...
const manager: Permission[] = [...staffRead,"CREATE_CASE","ASSIGN_CASES","REASSIGN_CASE_CUSTOMER","MANAGE_TASKS","ASSIGN_TASKS","MANAGE_SERVICE_REQUEST","ASSIGN_SERVICE_REQUEST","RESPOND_COMMUNICATIONS","MANAGE_QUESTIONS"];
